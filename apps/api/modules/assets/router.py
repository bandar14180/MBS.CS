...
async def list_assets(project_id: uuid.UUID, db: DbDep, ctx: WorkspaceContextDep) -> list[AssetRead]:
    assets = await service.list_assets(db, ctx.workspace_id, project_id)
