...
async def _set_ws(session, wid):
    # Phase 0 MySQL cutover: was a Postgres `set_config` GUC call; tenancy.bind_workspace is
    # the app-layer replacement (a plain ContextVar set) -- see apps.api.core.tenancy.
